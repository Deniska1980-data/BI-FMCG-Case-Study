...
Použitý dataset 📂 [MegaSlevy_elektronika_FMCG_zbozi_Analyza.csv](./MegaSlevy_elektronika_FMCG_zbozi_Analyza.csv)  obsahuje **simulovaná prodejní data** ze segmentů **FMCG a elektroniky** během promo období (např. Vánoce, Black Friday).
